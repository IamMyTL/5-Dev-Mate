    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('ads/update/'.$ad->id) }}">
                        @csrf
                        @method("PUT")
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="title" value="{{ $ad->title }}" required autocomplete="title">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="company" type="text" class="form-control @error('name') is-invalid @enderror" name="company" value="{{ $ad->company }}" required autocomplete="company" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control" name="description" required autocomplete="description" style="height:250px">{{$ad->description}}</textarea>
                            </div>
                        </div>
